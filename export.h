...
#define AG_CG_RESULT_WORD_LOSE	(24)
#define AG_CG_RESULT_WORD_WIN	(25)
#define AG_CG_LEMI_LOSE	(26)
#define AG_CG_LEMI_WIN	(27)
#define AG_CG_MAKO_LOSE	(28)
#define AG_CG_MAKO_WIN	(29)
